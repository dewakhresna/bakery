...
<div class="form-container">
  <form method="POST" action="{{ route('admin.edit_product_process', $product->id) }}" enctype="multipart/form-data" id="productForm">
    @csrf
    <div class="mb-3">
